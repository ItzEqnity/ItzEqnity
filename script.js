...
(function () {
  ...
  function runIntro(onDone) {
    ...
    const hide = () => {
      ...
      // hand over to the page as the wipe reveals it
      if (onDone) onDone();
    };
    ...
    // letters blur + scale in via CSS (staggered), bar + counter fill after a beat
    const start = 450;
    const duration = 1000;
    ...
    // letters fill in by ~1.5s, so wipe shortly after
